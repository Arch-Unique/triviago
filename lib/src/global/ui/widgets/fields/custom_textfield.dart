...
import 'package:triviago/src/utils/formatters/date_formatters.dart';
import 'package:triviago/src/utils/formatters/num_formatters.dart';
...
class CustomTextField extends StatelessWidget {
  ...
  const CustomTextField(this.hint, this.label, this.controller,
      ...
      this.col = AppColors.primaryColor,
            ...
            TextFormField(
              ...
              validator: (value) {
                setState(() {
                  ...
                  if (label == "Name" && !(value?.contains(" ") ?? true)) {
